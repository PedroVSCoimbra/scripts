...
ax1.plot(data['x']/0.1977, -data['Pressure_Coefficient'], 'o')
ax1.set_title("Plot Cp vs x/c eta=0.30")
ax1.set_xlabel("x/c")
ax1.set_ylabel("Cp")
plt.savefig('plots/cp30.jpg')
...
ax6.set_xlabel("x/c")
ax6.set_ylabel("Cp")
plt.savefig('plots/cp95.jpg')

# Make a pdf of With the plots
os.system('convert -density 100 plots/*.jpg plots/simple_report.pdf')
