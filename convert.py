...
meta_file = "/home/pedro/computer/wiki/metadata.yml"
...
def convert(
    ...
    # Mudei essa linha para não transformar arquivos locais em links da web (?!file:)
    #lines = re.sub(r"\[([^]]+)\]\((.+)|(?!file:)\)", repl, lines)
    lines = re.sub(r"\[([^]]+)\]\(((?!file).+)\)", repl, lines)
    ...
    command = [
       ...
       "--highlight-style=pygments",
        ...
        "--mathjax",
        #  "--bibliography",
        #  "/home/pedro/dados/faculdade/bibliografia/bibliography.bib",
    ]
